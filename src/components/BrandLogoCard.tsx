...
export default function BrandLogoCard({ image, position }: BrandLogoCardProps) {
  return (
    ...
    <div
      ...
      className="item absolute left-full flex h-20 w-40 items-center justify-center rounded-3xl border border-black/25 bg-white p-2 transition-all lg:h-24 lg:w-48"
    >
